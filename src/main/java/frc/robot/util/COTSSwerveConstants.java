...
public class COTSSwerveConstants {
    ...
    public COTSSwerveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, double angleKF, boolean driveMotorInvert, boolean angleMotorInvert, SensorDirectionValue canCoderInvert){
    ...
    public static COTSSwerveConstants SDSMK3(double driveGearRatio){
